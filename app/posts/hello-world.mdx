...
description: "This is my first blog post written in MDX. I discuss how I built this blog and the technology stack I used to create it."
tags: ["mdx", "remix", "blog"]
topic: Programming
author: Grassy
version: 2
...
```ts title="vite.config.ts" caption="tsx" {14-17}
...
```tsx title="posts.server.ts" caption="tsx"
const getPostFiles = () => {
...
```tsx title="mdx-compiler.server.ts" caption="tsx"
...
```tsx title="blog.tsx" caption="tsx"
...
```tsx title="blog.$slug.tsx" caption="tsx"
